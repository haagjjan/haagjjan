...
### [PhantomHunt](https://github.com/haagjjan/PhantomHunt)

A Java multiplayer game built as a University of Basel programming project. Four players join an asymmetric 3-vs-1 round with lobbies, chat, scoring, and a JavaFX client.

**Tech / focus:** Java, Gradle, JavaFX, TCP client-server networking, JUnit, Mockito, JaCoCo  
**What I learned:** Working in a team on a larger codebase, designing game-state logic, connecting a GUI to networked gameplay, and keeping features testable.
...
**Languages:** Java, Python, TypeScript, SQL, HTML/CSS, Bash  
**Frameworks and libraries:** JavaFX, JUnit, TensorFlow/Keras, NumPy, Next.js, Fastify, Kysely, Zod  
**Tools:** Git, GitHub, GitLab, Gradle, Docker Compose, PostgreSQL, pnpm, VS Code, IntelliJ IDEA

## Contact / Links

- GitHub: [@haagjjan](https://github.com/haagjjan)
- Main portfolio projects: [PhantomHunt](https://github.com/haagjjan/PhantomHunt), [Gym Progress Tracker](https://github.com/haagjjan/gym-track), [MNIST_DNN](https://github.com/haagjjan/MNIST_DNN)
